...
const register = async(req, res)=>{
    try{
        ...
        res.status(500).json({msg:"something went wrong /in the registration",error:error.message})
    }
}
...
const login = async(req, res)=>{
    try{
        ...
        res.status(500).json({msg:"something went wrong /in the login",error:error.message})
    }
}
...
const getUserData = async(req, res)=>{
    try{
        ...
        res.status(500).json({msg:"something went wrong /in the getting of the userData",error:error.message})
    }
}
